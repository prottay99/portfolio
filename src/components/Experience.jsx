  ...
  return (
    <div id="Experience" className="pb-4">
      <motion.h2
        ...
        className="my-20 to-current text-4xl"
      >
        Experince
      </motion.h2>
      <div>
        {EXPERIENCES.map((experice, index) => (
          <div key={index} className="mb-8 flex flex-wrap">
            ...
            >
              <p className="mb-2 text-sm text-stone-400">{experice.year}</p>
            </motion.div>
            <motion.div
              whileInView={{ opacity: 1, x: 0 }}
              initial={{ opacity: 0, x: -100 }}
            ...
            >
              ...
              <p className="mb-4 text-stone-400">{experice.description}</p>
              {experice.technologies.map((tech, index) => (
                <span
                  key={index}
